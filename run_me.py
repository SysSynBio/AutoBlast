...
if (__name__ == "__main__") :
    args=sys.argv[1:]
    if len(args) < 1:
        print "input format: python auto_homology.py <fasta file that NCBI BLAST will be ran against> \n"
        print "example usage: python auto_homology.py DGAT_target.fasta \n"
        exit(1)

fasta_file_name = args[0]
print "Step 1. Auto_homology searches NCBI website with " + str(fasta_file_name) + ". Please wait.\n"
print "\tFor example,\n"
